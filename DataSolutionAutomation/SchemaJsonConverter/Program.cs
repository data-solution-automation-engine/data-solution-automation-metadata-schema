...
using DataSolutionAutomation.DsaModel;

string jsonSchema = string.Empty;

try
{
    jsonSchema = AppDomain.CurrentDomain.BaseDirectory + @"..\..\..\..\..\GenericInterface\interfaceDataSolutionAutomationMetadataV2_0.json";
}
catch
{
