...
public class DataClassification
{
    ...
    /// <summary>
    /// The grouping or category for this classification (e.g. "Solution Layer", "Logical", "Physical").
    /// Used to organise classifications into related sets.
    /// </summary>
    ...
    /// <summary>
    /// The scope areas in which this classification is applicable.
    /// When null or empty, the classification applies everywhere.
    /// Values are camelCase tokens such as "dataObjects", "connections", "mappings", "templates", "graph".
    /// </summary>
